    ...
    def get_gold_profile(symbol: str = "XAUUSD") -> InstrumentSpec:
        ...
        return InstrumentSpec(
            ...
            behavior=AssetBehavior(
                ...
                failure_modes=["fake_breakout", "liquidity_sweep"],
            ...
            preferred_strategies=["trend_following", "volatility_breakout", "liquidity_sweep_fade"],
            restricted_strategies=["simple_rsi_overbought"]
        )
